...
zeroPhase = findZeroPhase(zData,phase,0);
...
subplot(2,2,2);
setImage(222,zData,intensity,'Position z(\mum)','Intensity(a.u.)');
subplot(2,2,4);
setImage(224,zData,phase,'Position z(\mum)','Phase(rad)',zeroPhase);%
